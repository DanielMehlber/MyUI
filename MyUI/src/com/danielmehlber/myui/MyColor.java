...
public class MyColor extends Color {
    ...
    public final static MyColor BLUE_DEEP_SEA = new MyColor(5, 38, 59);
    public final static MyColor YELLOW_C = new MyColor(228, 217, 75);
    public final static MyColor BLUE_GREYISH = new MyColor(61, 72, 85);
