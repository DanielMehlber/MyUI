...
public class MyProgessChart extends JPanel implements Designable {
	...
	public void paintComponent(Graphics g) {
		...
		g2d.drawArc(stroke_thickness, stroke_thickness, getWidth() - stroke_thickness * 2,
				getHeight() - stroke_thickness * 2, 90, 360);
		for (MyChartEntry entry : entries) {
			g2d.setColor(entry.getColor());
			g2d.drawArc(stroke_thickness, stroke_thickness, getWidth() - stroke_thickness * 2,
					getHeight() - stroke_thickness * 2, 90, (int) (-360f / 100f * entry.getPercent() * fac));
		}
