...
public class MyButton extends JPanel implements Designable, MyRunnable {
	...
	protected void paintComponent(Graphics g) {
		...
		if (shady) {
			...
			graphics.fillRoundRect(shadowXOffset, // X position
		...
		graphics.fillRoundRect(0, 0, width - shadowGap * shadowXOffset, height - shadowGap * shadowYOffset, roundness,
				roundness);
		/*
		 * graphics.setColor(getForeground()); graphics.setStroke(new
		 * BasicStroke(strokeSize)); graphics.drawRoundRect(0, 0, width - shadowGap,
