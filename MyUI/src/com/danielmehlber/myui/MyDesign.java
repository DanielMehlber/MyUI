...
public class MyDesign {
	...
	public final static MyDesign BEACH = new MyDesign(new MyColor(71,92,122), new MyColor(252, 187, 109),  MyColor.WHITE);
	public final static MyDesign ORANGE_IS_THE_NEW_BLUE = new MyDesign(new MyColor(50, 93, 121), new MyColor(242,102,39), MyColor.WHITE);
